...
export function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccessToast("Success", "Authenticated successfully");
      
      const from = location.state?.from?.pathname || "/dashboard";
      navigate(from, { replace: true });
    } catch (err: any) {
      showErrorToast("Authentication Failed", err.message || "Invalid email or password");
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 relative">
      <Link
        to="/"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border shadow-xl bg-card/60 backdrop-blur-md">
          <CardHeader>
            ...
            <CardDescription>
              Sign in with your admin or citizen account credentials to continue.
            </CardDescription>
          </CardHeader>
          <CardContent>
